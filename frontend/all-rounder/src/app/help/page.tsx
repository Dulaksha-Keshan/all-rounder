...
//   gsap.from(section.querySelectorAll(".faq-item-card"), {
//         scrollTrigger: {
//           trigger: section,
//           start: "top 85%",
//           toggleActions: "play none none none",
...
//       {/* HEADER */}
//       <section className="relative bg-[#34365C] py-24 overflow-hidden text-white w-screen -mx-4">

//         {/* ⭐ Blinking Stars */}
//         {/* 🌟 GSAP BIG STARS */}
// <span className="big-star float-star absolute top-16 left-20 text-5xl text-white">★</span>
// <span className="big-star float-star absolute top-32 right-28 text-6xl text-white">★</span>
// <span className="big-star float-star absolute bottom-24 left-1/4 text-4xl text-white">★</span>
// <span className="big-star float-star absolute bottom-16 right-20 text-5xl text-white">★</span>
// <span className="big-star float-star absolute top-1/2 left-12 text-4xl text-white">★</span>
...
//                 outline-none
//                 focus:ring-2 focus:ring-[var(--primary-purple)]
//                 transition
//               "
//             />
//           </div>
