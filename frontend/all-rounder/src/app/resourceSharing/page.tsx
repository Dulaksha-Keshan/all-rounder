...
export default function ResourceSharingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F8F8FF]">
      {/* ── Hero Section ── */}
      <section className="relative bg-[#34365C] overflow-hidden">
        {/* Decorative stars */}
        <span className="absolute top-8 right-16 text-[#8387CC] opacity-40 text-4xl select-none pointer-events-none">★</span>
        <span className="absolute bottom-12 left-1/3 text-[#8387CC] opacity-25 text-3xl select-none pointer-events-none">★</span>
        <span className="absolute top-1/2 right-1/4 text-[#8387CC] opacity-20 text-5xl select-none pointer-events-none">★</span>
        <span className="absolute top-6 left-10 text-[#8387CC] opacity-15 text-2xl select-none pointer-events-none">★</span>
        ...
        <div className="max-w-7xl mx-auto px-6 py-14">
          ...
          <nav className="flex items-center gap-2 text-sm text-gray-400 mb-6">
            ...
            <span className="text-gray-300 font-medium">Resource Sharing</span>
          </nav>

          {/* Title */}
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 leading-tight">
            Resource Sharing{" "}
            <span className="text-[#4169E1]">Hub</span>
          </h1>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="flex gap-3 mb-7 flex-wrap">
          {(["requests", "myRequests"] as const).map((tab) => (
            <button
              key={tab}
            ...
            >
              {tab === "requests" ? "Resource Requests" : "My Requests"}
            </button>
          ))}
        </div>
          ...
          <div className="flex gap-3 flex-wrap items-center">
            ...
            <div className="flex-1 min-w-[220px] relative">
              ...
              <input
                ...
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                className="w-full pl-9 pr-4 py-2.5 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#8387CC] focus:border-transparent"
              />
            </div>
            ...
            <div className="relative">
              ...
              <select
                ...
                className="pl-9 pr-4 py-2.5 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#8387CC] bg-white appearance-none cursor-pointer"
              >
            ...
            <select
              ...
              className="px-4 py-2.5 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#8387CC] bg-white cursor-pointer"
            >
        ...
        {activeTab === "requests" && (
          <>
            <p className="text-sm text-gray-500 mb-5">
              Showing{" "}
              <span className="font-semibold text-[#34365C]">{filteredRequests.length}</span> of{" "}
              <span className="font-semibold text-[#34365C]">{RESOURCE_REQUESTS.length}</span> requests
            </p>

            {filteredRequests.length === 0 ? (
              <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-16 text-center">
                <Package className="w-14 h-14 text-gray-300 mx-auto mb-4" />
                <h3 className="text-lg font-semibold text-[#34365C] mb-2">No requests found</h3>
        ...
        {activeTab === "myRequests" && (
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-16 text-center">
            <Package className="w-14 h-14 text-gray-300 mx-auto mb-4" />
            <h3 className="text-lg font-semibold text-[#34365C] mb-2">No Active Requests</h3>
            <p className="text-gray-500 text-sm mb-6">
              You haven&apos;t created any resource requests yet
            </p>
            <Link
              href="./addResourceRequest"
              className="inline-flex items-center gap-2 px-6 py-3 bg-[#4169E1] text-white rounded-lg hover:bg-[#3557c1] transition-colors text-sm font-medium"
            >
              <Plus className="w-4 h-4" />
              Create Your First Request
            </Link>
        ...
        {/* ── Notification Banner ── */}
        <div className="mt-8 bg-gradient-to-r from-[#8387CC] to-[#4169E1] rounded-xl p-6 flex items-start gap-4">
          <div className="w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
            <Bell className="w-5 h-5 text-white" />
          </div>
          <div>
            <h4 className="text-white font-semibold mb-1">Enable Notifications</h4>
            <p className="text-[#DCD0FF] text-sm mb-4">
              Get automatic notifications when new resource requests match your interests
            </p>
            <button className="px-5 py-2 bg-white text-[#34365C] rounded-lg hover:bg-[#DCD0FF] transition-colors text-sm font-medium">
              Enable Notifications
            </button>
          </div>
        </div>
