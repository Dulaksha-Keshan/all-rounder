      ...
      <div className="relative max-w-7xl mx-auto px-4 py-12">
        ...
        {activeTab === "campaigns" && (
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {campaigns.map((c) => (
              <div
                key={c.id}
                className="group relative bg-gradient-to-br from-white via-[#F8F8FF] to-[#EEF0FF] rounded-2xl shadow-md hover:shadow-2xl transition-all duration-300 overflow-hidden"
              >
                {/* Glow */}
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-gradient-to-br from-[#8387CC]/20 to-[#4169E1]/20" />

                {/* Icon Header */}
                <div className="relative h-36 flex items-center justify-center">
                  <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#8387CC] to-[#4169E1] flex items-center justify-center shadow-lg transition-all duration-300">
                ...
                <div className="relative p-6">
                  <div className="flex justify-between mb-2">
                    <span className="text-xs px-3 py-1 rounded-full bg-[#DCD0FF] text-[#505485] transition-colors duration-300">
                      {c.category}
                    </span>
                  ...
                  <div className="mb-5">
                    ...
                    <div className="w-full h-2 bg-gray-200 rounded-full transition-colors duration-300">
                      <div
                        className="h-2 rounded-full bg-gradient-to-r from-[#8387CC] to-[#4169E1] transition-all duration-300"
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex gap-2">
                      <button className="p-2 rounded-lg bg-[#F8F8FF] hover:bg-[#DCD0FF] transition-all duration-300">
                        <Share2 className="w-4 h-4 text-[#505485] transition-colors duration-300" />
                      </button>
                      <button className="px-4 py-2 rounded-lg bg-gradient-to-r from-[#4169E1] to-[#2f4fd4] text-white hover:scale-[1.05] transition-all duration-300 text-sm">
                        Donate
                      </button>
                    </div>
                  </div>
        ...
        {activeTab === "myCampaigns" && (
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 bg-card rounded-2xl shadow-lg p-8 transition-colors duration-300">
              ...
              {["Tech Corp Foundation", "Anonymous Donor", "Parent Association"].map(
                (d, i) => (
                  <div
                    key={i}
                    className="flex justify-between items-center p-4 mb-3 rounded-xl bg-[#F8F8FF] transition-colors duration-300"
                  >
                    <span className="text-main transition-colors duration-300">{d}</span>
                    <span className="text-[#4169E1] font-medium transition-colors duration-300">
                      {formatLKR(2500000)}
                    </span>
                  </div>
                )
            ...
            <div className="bg-gradient-to-br from-[#8387CC] to-[#4169E1] rounded-2xl p-8 text-white shadow-xl transition-all duration-300">
              ...
              <button className="w-full py-3 rounded-lg bg-white text-[#34365C] font-medium hover:bg-[#DCD0FF] transition-all duration-300">
                View Analytics
              </button>
            </div>
          </div>
...
function Stat({
  ...
  return (
    <div className="rounded-xl p-4 bg-gradient-to-br from-[#F8F8FF] to-[#EEF0FF] transition-colors duration-300">
      <div className="w-8 h-8 text-[#4169E1] mb-2 transition-colors duration-300">
        {icon}
      </div>
