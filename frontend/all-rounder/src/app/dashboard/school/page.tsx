...
//           <span className="hidden lg:block font-bold text-[#34365C]">All-Rounder</span>
//         </div>
//         <Menu />
//       </div>

//       {/* RIGHT CONTENT */}
//       <div className="w-[86%] md:w-[92%] lg:w-[84%] xl:w-[86%] bg-[#F8F8FF] overflow-scroll">
//         <div className="p-6">
//           <div className="max-w-[1400px] mx-auto">
//             {/* Stats Cards */}
//             <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
...
//                   {schoolEvents.length}
//                 </h1>
//                 <h2 className="capitalize text-lg font-medium text-white/90">
//                   Events
//                 </h2>
//               </div>
//             </div>
