...
export default function LandingPage() {
  ...
  useEffect(() => {
    ...
    if (stakeholderRef.current) {
      const sections = stakeholderRef.current.querySelectorAll('.stakeholder-card');
      gsap.fromTo(sections,
        { x: -30, opacity: 0 },
        {
          ...
          stagger: 0.2,
          scrollTrigger: {
            trigger: stakeholderRef.current,
            start: "top 80%",
          }
        }
      );
  ...
  return (
    ...
    <div className="flex flex-col min-h-screen bg-[var(--page-bg)] transition-colors duration-300">
      ...
      <main className="flex-grow">
        ...
        {/* Our Vision & Mission */}
        <div ref={missionRef} className="mx-4 sm:mx-8 lg:mx-16 mt-12 sm:mt-16 lg:mt-20 sm:mb-8"
          id="AboutUs">
          <div className="mb-6 sm:mb-8 text-center">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-[var(--text-main)] mb-2">Our Vision & Mission</h2>
            <p className="text-[var(--text-muted)] text-base sm:text-lg lg:text-xl px-4">Empowering students to showcase their unique journey through three core pillars that define our platform.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="mission-card bg-[var(--gray-50)] rounded-xl p-6 sm:p-8 shadow-lg border-2 border-[var(--secondary-light-lavender)]/20 hover:border-[var(--primary-purple)] transition-all hover:shadow-xl opacity-0">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-[var(--text-main)] mb-3 sm:mb-4">Create</h3>
              <p className="text-justify text-[var(--text-muted)] leading-relaxed mb-4 text-base sm:text-lg">
            ...
            <div className="mission-card bg-[var(--gray-50)] rounded-xl p-6 sm:p-8 shadow-lg border-2 border-[var(--secondary-light-lavender)]/20 hover:border-[var(--primary-purple)] transition-all hover:shadow-xl opacity-0">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-[var(--text-main)] mb-3 sm:mb-4">Contribute</h3>
              <p className="text-justify text-[var(--text-muted)] leading-relaxed mb-4 text-base sm:text-lg">
            ...
            <div className="mission-card bg-[var(--gray-50)] rounded-xl p-6 sm:p-8 shadow-lg border-2 border-[var(--secondary-light-lavender)]/20 hover:border-[var(--primary-purple)] transition-all hover:shadow-xl md:col-span-2 lg:col-span-1 opacity-0">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-[var(--text-main)] mb-3 sm:mb-4">Celebrate</h3>
              <p className="text-justify text-[var(--text-muted)] leading-relaxed mb-4 text-base sm:text-lg">
        ...
        <div ref={stakeholderRef} className="mb-12 sm:mb-16 mx-4 sm:mx-8 lg:mx-16">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-[var(--text-main)] mb-3 sm:mb-4 text-center px-4">
            Empowering Every Stakeholder
          </h2>
          <p className="text-base sm:text-lg text-[var(--text-muted)] mb-8 sm:mb-12 text-center max-w-3xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="stakeholder-card bg-gradient-to-br from-[var(--secondary-light-lavender)]/20 to-[var(--secondary-pale-lavender)]/10 rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-xl transition-all border-2 border-[var(--primary-purple)]/20 opacity-0">
              ...
              <ul className="space-y-3 sm:space-y-4">
                <li className="flex items-start text-sm sm:text-base text-[var(--text-muted)]">
