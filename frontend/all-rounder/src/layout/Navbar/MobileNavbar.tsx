        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="p-2 rounded-full hover:bg-[#DCD0FF] dark:hover:bg-purple-900 transition"
              style={{ 
          ...
          <button
            ...
            className="flex items-center gap-2 px-3 py-2 rounded-full hover:bg-[#DCD0FF] dark:hover:bg-purple-900 transition"
            style={{ 
              backgroundColor: 'transparent',
              '--hover-bg': cssVariables.colors.secondaryLavender 
            } as React.CSSProperties}
